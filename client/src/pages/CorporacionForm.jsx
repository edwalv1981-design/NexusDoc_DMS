    ...
    return (
        <div className="expert-container">
            ...
            <style>{`
                ...
                .expert-btn-add-white { background: ${PRIMARY}0a; color: ${PRIMARY}; border: 1px solid ${PRIMARY}30; padding: 4px 10px; border-radius: 4px; font-weight: 700; cursor: pointer; display: flex; align-items: center; gap: 4px; font-size: 10px; transition: all 0.15s; }
                ...
                .corp-autocomplete-dropdown { position: absolute; top: 100%; left: 0; right: 0; z-index: 100; background: white; border: 1px solid #e2e8f0; border-radius: 5px; box-shadow: 0 4px 16px rgba(0,0,0,0.1); max-height: 180px; overflow-y: auto; margin-top: 1px; }
                ...
                .corp-ac-passport { font-size: 11px; font-weight: 700; color: ${SECONDARY}; }
                .corp-ac-name { font-size: 10px; color: #64748b; font-weight: 500; }
