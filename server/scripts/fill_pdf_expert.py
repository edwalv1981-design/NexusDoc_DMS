...
def fill_pdf_universal_engine(data, output_path, template_name, master_config, custom_template_path=None, field_mapping=None):
    ...
    # ══════════════════════════════════════════════════════════════════════════════
        ...
        page1.insert_text((90, 434.0), "Other forms of income / Otras formas de ingresos", fontsize=9, fontname="Helvetica")
        if data.get("fundsOther"):
            page1.insert_text((225, 445.3), str(data["fundsOther"])[:100], fontsize=9, fontname="Helvetica")
