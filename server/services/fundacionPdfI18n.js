...
const ES = Object.freeze({
  ...
  sectionCouncil: 'Consejo de Fundación / Directores',
  ...
  sectionPowers: 'Poderes de Representación',
  powerType: 'Tipo de Poder',
  powerHolder: 'Datos del Apoderado',
  powerHolderName: 'Nombre Completo',
  powerHolderPassport: 'Pasaporte / Cédula',
  powerHolderAddress: 'Dirección',
  powerScope: 'Facultades Otorgadas',
  powerScopeCustom: 'Facultades Adicionales',
...
const EN = Object.freeze({
  ...
  sectionCouncil: 'Foundation Council / Directors',
  ...
  sectionPowers: 'Powers of Representation',
  powerType: 'Type of Power',
  powerHolder: 'Attorney-in-Fact Details',
  powerHolderName: 'Full Name',
  powerHolderPassport: 'Passport / ID',
  powerHolderAddress: 'Address',
  powerScope: 'Granted Powers / Scope',
  powerScopeCustom: 'Additional Custom Powers',
