...
const ES = Object.freeze({
  ...
  dignitaryPassport: 'Pasaporte',
  dignitaryRegistrationNumber: 'Número de registro (si es empresa)',
  sectionBeneficiaries: 'Beneficiarios',
  beneficiaryName: 'Nombre completo',
  beneficiaryBirthDate: 'Fecha de nacimiento',
  beneficiaryPassport: 'Pasaporte/Cédula',
...
const EN = Object.freeze({
  ...
  dignitaryPassport: 'Passport',
  dignitaryRegistrationNumber: 'Registration number (if company)',
  sectionBeneficiaries: 'Beneficiaries',
  beneficiaryName: 'Full name',
  beneficiaryBirthDate: 'Date of birth',
  beneficiaryPassport: 'Passport/ID',
