...
const ES = Object.freeze({
  ...
  sectionPowers: 'Power of Attorney / Poderes (Optional)',
  poaIssueQuestion: '¿Quiere Usted emitir un poder? / Would you like to issue a Power of Attorney?',
  poaTypeQuestion: 'If Yes please select type of Power of Attorney / Tipo de Poder:',
  poaValidityQuestion: 'Validity date / Fecha de vigencia:',
  poaLegalizedQuestion: 'Would you require the POA to be legalized? / ¿Requiere que el poder sea legalizado?',
...
const EN = Object.freeze({
  ...
  sectionPowers: 'Power of Attorney / Poderes (Optional)',
  poaIssueQuestion: 'Would you like to issue a Power of Attorney? / ¿Quiere Usted emitir un poder?',
  poaTypeQuestion: 'If Yes please select type of Power of Attorney / Tipo de Poder:',
  poaValidityQuestion: 'Validity date / Fecha de vigencia:',
  poaLegalizedQuestion: 'Would you require the POA to be legalized? / ¿Requiere que el poder sea legalizado?',
